            ...
            <div className="border-box-image d-flex flex-column justify-content-between align-items-center flex-md-row p-3 p-md-0">
                ...
                <div className="d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div className="btn-box d-flex flex-row justify-content-around w-50">
                      ...
                      <a href="https://norgard7.github.io/daily-planner/" target="_blank" className="btn btn-outline px-4" aria-hidden="true"><span class="visually-hidden">Click to open project</span>Open Project</a>
                      {/* <!-- second button opens code --> */}
                      <a href="https://github.com/norgard7/daily-planner" target="_blank" className="btn btn-outline px-4" role="button">See Code</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="carousel-item container-background ">
                <div className="border-box-image d-flex flex-column justify-content-between align-items-center flex-md-row p-3 p-md-0">
                    ...
                    <div className="d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div className="btn-box d-flex flex-row justify-content-around w-50">
                          <a href="https://norgard7.github.io/javascript-coding-quiz/" target="_blank" class="btn btn-outline px-4" role="button">Open Project</a>
                          <a href="https://github.com/norgard7/javascript-coding-quiz" target="_blank" class="btn btn-outline px-4" role="button">See Code</a>
    ...
    <div className="carousel-item container-background ">
      <div className="border-box-image d-flex flex-column justify-content-between align-items-center flex-md-row p-3 p-md-0">
          ...
          <div className="d-flex flex-column align-items-center justify-content-center">
              ...
              <div className="btn-box d-flex flex-row justify-content-around w-50">
                <a href=" https://norgard7.github.io/weather-dashboard/" target="_blank" class="btn btn-outline" role="button">Open Project</a>
                <a href="https://github.com/norgard7/weather-dashboard" target="_blank" class="btn btn-outline px-4" role="button">See Code</a>
            </div>
          </div>
      </div>
  </div>
  ...
  <div className="carousel-item container-background ">
    <div className="border-box-image d-flex flex-column justify-content-between align-items-center flex-md-row p-3 p-md-0">
        ...
        <div className="d-flex flex-column align-items-center justify-content-center">
            ...
            <div className="btn-box d-flex flex-row justify-content-around w-50">
              <a href="https://norgard7.github.io/passcode-generator/" target="_blank" class="btn btn-outline" role="button">Open Project</a>
              <a href="https://github.com/norgard7/passcode-generator" target="_blank" class="btn btn-outline px-4" role="button">See Code</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="carousel-item container-background ">
      <div className="border-box-image d-flex flex-column justify-content-between align-items-center flex-md-row p-3 p-md-0">
          ...
          <div className="d-flex flex-column align-items-center justify-content-center">
              ...
              <div className="btn-box d-flex flex-row justify-content-around w-50">
                <a href=" https://norgard7.github.io/stock-finder/" target="_blank" class="btn btn-outline" role="button">Open Project</a>
                <a href="https://github.com/norgard7/stock-finder" target="_blank" class="btn btn-outline px-4" role="button">See Code</a>
            </div> 
          </div>
        </div>
      </div>
      ...
      <div className="carousel-item container-background ">
        <div className="border-box-image d-flex flex-column justify-content-between align-items-center flex-md-row p-3 p-md-0">
            ...
            <div className="d-flex flex-column align-items-center justify-content-center">
                ...
                <div className="btn-box d-flex flex-row justify-content-around w-50">
                  <a href="https://norgard7.github.io/simon-game/" target="_blank" class="btn btn-outline" role="button">Open Project</a>
                  <a href="https://github.com/norgard7/simon-game" target="_blank" class="btn btn-outline px-4" role="button">See Code</a>
              </div> 
            </div>
          </div>
      </div>
      ...
      <div className="carousel-item container-background ">
        <div className="border-box-image d-flex flex-column justify-content-between align-items-center flex-md-row p-3 p-md-0">
            ...
            <div className="d-flex flex-column align-items-center justify-content-center">
                ...
                <div className="btn-box d-flex flex-row justify-content-around w-50">
                  <a href="https://the-hattrick-platform.herokuapp.com/" target="_blank" class="btn btn-outline" role="button">Open Project</a>
                  <a href="https://github.com/norgard7/Project_2_Purity_Ring" target="_blank" class="btn btn-outline px-4" role="button">See Code</a>
              </div> 
            </div>
          </div>
      </div>
      ...
      <div className="carousel-item container-background ">
        <div className="border-box-image d-flex flex-column justify-content-between align-items-center flex-md-row p-3 p-md-0">
            ...
            <div className="d-flex flex-column align-items-center justify-content-center">
                ...
                <div className="btn-box d-flex flex-row justify-content-around w-50">
                  <a href="https://ln-tech-blog.herokuapp.com/" target="_blank" class="btn btn-outline" role="button">Open Project</a>
                  <a href="https://github.com/norgard7/tech-blog" target="_blank" class="btn btn-outline px-4" role="button">See Code</a>
              </div> 
            </div>
          </div>
      </div>
      ...
      <div className="carousel-item container-background ">
        <div className="border-box-image d-flex flex-column justify-content-between align-items-center flex-md-row p-3 p-md-0">
            ...
            <div className="d-flex flex-column align-items-center justify-content-center">
                ...
                <div className="btn-box d-flex flex-row justify-content-around w-50">
                  <a href="https://drive.google.com/file/d/12Vnq7vHg0pHCd6X7VNRdjjxPakwCNNFc/view" target="_blank" class="btn btn-outline" role="button">Open Project</a>
                  <a href="https://github.com/norgard7/e-commerce" target="_blank" class="btn btn-outline px-4" role="button">See Code</a>
              </div> 
            </div>
          </div>
      </div>
      ...
      <div className="carousel-item container-background ">
        <div className="border-box-image d-flex flex-column justify-content-between align-items-center flex-md-row p-3 p-md-0">
            ...
            <div className="d-flex flex-column align-items-center justify-content-center">
                ...
                <div className="btn-box d-flex flex-row justify-content-around w-50">
                  <a href="https://ln-notetaker.herokuapp.com/" target="_blank" class="btn btn-outline" role="button">Open Project</a>
                  <a href="https://github.com/norgard7/note-taker" target="_blank" class="btn btn-outline px-4" role="button">See Code</a>
              </div> 
            </div>
          </div>
      </div>
